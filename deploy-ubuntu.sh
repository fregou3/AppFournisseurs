...
print_info "Utilisation de l'adresse IP publique '$DOMAIN_NAME'"

# Définir le port pour le backend
BACKEND_PORT="5005"
print_info "Utilisation du port $BACKEND_PORT pour le backend."

# Définir le chemin du répertoire virtuel
VIRTUAL_DIR="fournisseurs"
print_info "Utilisation de '/$VIRTUAL_DIR' comme répertoire virtuel."

# 1. Installer les dépendances système
print_step 1 "Installation des dépendances système..."
apt update || print_error "Impossible de mettre à jour les paquets."
apt install -y curl git nginx software-properties-common || print_error "Impossible d'installer les dépendances système."
...
systemctl restart nginx || print_error "Impossible de redémarrer Nginx."
