...
# Script simple pour exécuter le fichier SQL qui crée la table system_group_metadata
...
docker cp "$SCRIPT_DIR/create_group_metadata_table.sql" pg-temp:/tmp/

# Exécuter le script SQL dans le conteneur
echo "Exécution du script SQL..."
docker exec pg-temp psql -U postgres -d postgres -f /tmp/create_group_metadata_table.sql
RESULT=$?
