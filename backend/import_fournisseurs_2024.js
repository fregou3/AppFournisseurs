/**
 * Script pour importer le fichier Fournisseurs_2024.xlsx directement dans la base de données
 * en s'assurant que toutes les colonnes sont créées, même si elles sont vides
 */
...
async function main() {
  ...
  try {
    ...
    if (scoreResult.rows.length > 0) {
      console.log(`\nLa colonne Score existe bien dans la table ${tableName}.`);
    } else {
      console.log(`\nATTENTION: La colonne Score n'existe pas dans la table ${tableName}.`);
    }
