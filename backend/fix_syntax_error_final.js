...
// Réécrire complètement le fichier avec une version simplifiée et fonctionnelle
  ...
  try {
    ...
    try {
      ...
      console.log('Données récupérées de la table', tableName, ':', {
        ...
        firstRow: result.rows.length > 0 ? JSON.stringify(result.rows[0]).substring(0, 100) + '...' : 'aucune donnée'
      });
