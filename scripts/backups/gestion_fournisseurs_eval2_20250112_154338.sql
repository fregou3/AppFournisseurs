...
ALTER TABLE public.eval2_antecedents_avec_le_tiers_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_categorisation_tiers_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_criteres_selection_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_duree_envisagee_de_la_relation_contractuelle_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_encadrement_relation_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_evaluation_risque_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_flux_financier_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_interaction_tiers_autre_partie_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_intervention_autre_partie_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_localisation_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_modalites_de_renouvellement_contrat_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_modalites_paiement_reglement_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_nature_tiers_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_niveau_dependance_clarins_vs_tiers_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_niveau_dependance_tiers_vs_clarins_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_pays_intervention_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_qualification_tiers_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_raisons_relation_id_seq OWNER TO admin;
...
ALTER TABLE public.eval2_region_intervention_id_seq OWNER TO admin;
