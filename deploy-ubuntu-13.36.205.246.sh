...
# IP publique : 13.36.205.246
# Nom de domaine : app2.communify.solutions
# Version : 1.2 - Avec support pour le domaine personnalisé
##############################################################
...
IP_ADDRESS="13.36.205.246"
DOMAIN_NAME="app2.communify.solutions"
BACKEND_PORT="5005"
