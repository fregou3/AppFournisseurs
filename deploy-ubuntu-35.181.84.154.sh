...
# IP publique : 35.181.84.154
# Nom de domaine : supplier-prd.communify.solutions
# Version : 1.3 - Avec support pour Node.js 18.20 et corrections des permissions
##############################################################
...
IP_ADDRESS="35.181.84.154"
DOMAIN_NAME="supplier-prd.communify.solutions"
BACKEND_PORT="5005"
VIRTUAL_DIR="fournisseurs"

print_info "Configuration pour le déploiement :"
print_info "- Adresse IP : $IP_ADDRESS"
print_info "- Nom de domaine : $DOMAIN_NAME"
...
echo -e "${GREEN}===============================================${NC}"
echo -e "L'application est accessible aux adresses :"
echo -e "  - ${BLUE}http://$DOMAIN_NAME/$VIRTUAL_DIR${NC} (Nom de domaine)"
echo -e "  - ${BLUE}http://$IP_ADDRESS/$VIRTUAL_DIR${NC} (Adresse IP)"
echo -e "L'API est accessible aux adresses :"
echo -e "  - ${BLUE}http://$DOMAIN_NAME/$VIRTUAL_DIR/api${NC} (Nom de domaine)"
echo -e "  - ${BLUE}http://$IP_ADDRESS/$VIRTUAL_DIR/api${NC} (Adresse IP)"
...
# Rappel pour la configuration DNS
echo -e "\n${YELLOW}RAPPEL IMPORTANT :${NC}"
echo -e "N'oubliez pas de configurer votre DNS pour que le domaine ${BLUE}$DOMAIN_NAME${NC} pointe vers l'adresse IP ${BLUE}$IP_ADDRESS${NC}."
echo -e "Cela peut prendre jusqu'à 24-48 heures pour que les modifications DNS se propagent complètement."
